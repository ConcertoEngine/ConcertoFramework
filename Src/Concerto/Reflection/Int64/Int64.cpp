...
namespace cct::refl
{
	...
	cct::Int64 Int64::Get() const
	{
		return m_value;
	}
	Int64::operator cct::Int64() const
	{
		return m_value;
	}

	Int64& Int64::operator=(cct::Int64 value)
	{
		Set(value);
		return *this;
	}
	...
	bool Int64::operator==(cct::Int64 other) const
	{
