...
namespace cct::refl
{
	UInt16::UInt16(cct::UInt16 value) :
		m_value(value)
	{
	}
	...
	cct::UInt16 UInt16::Get() const
	{
		return m_value;
	}
	UInt16::operator cct::UInt16() const
	{
		return m_value;
	}

	UInt16& UInt16::operator=(cct::UInt16 value)
	{
		Set(value);
		return *this;
	}

	bool UInt16::operator==(const UInt16& other) const
	{
	...
	bool UInt16::operator==(cct::UInt16 other) const
	{
