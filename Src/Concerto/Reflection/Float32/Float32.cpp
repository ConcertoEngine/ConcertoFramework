...
namespace cct::refl
{
	Float32::Float32(cct::Float32 value) :
		m_value(value)
	{
	}
	...
	cct::Float32 Float32::Get() const
	{
		return m_value;
	}
	Float32::operator cct::Float32() const
	{
		return m_value;
	}

	Float32& Float32::operator=(cct::Float32 value)
	{
		Set(value);
		return *this;
	}
	...
	bool Float32::operator==(cct::Float32 other) const
	{
	...
	std::string Float32::ToString() const
	{
		...
		oss << std::fixed << std::setprecision(6) << m_value;
