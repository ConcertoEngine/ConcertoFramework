...
namespace cct::refl
{
	...
	cct::Int32 Int32::Get() const
	{
		return m_value;
	}
	Int32::operator cct::Int32() const
	{
		return m_value;
	}

	Int32& Int32::operator=(cct::Int32 value)
	{
		Set(value);
		return *this;
	}

	bool Int32::operator==(const Int32& other) const
	{
	...
	bool Int32::operator==(cct::Int32 other) const
	{
