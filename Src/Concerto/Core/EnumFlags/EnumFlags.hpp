...
namespace cct
{
	...
	public:
		...
		constexpr explicit EnumFlags(Underlying raw) noexcept :
			_value(raw)
		{
		}

		[[nodiscard]] static constexpr EnumFlags FromRaw(Underlying raw) noexcept
		{
			return EnumFlags(raw);
		}
		...
		// Comparisons
		[[nodiscard]] constexpr bool operator==(EnumFlags other) const noexcept
		{
